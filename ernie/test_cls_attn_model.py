...
class Ernierna(nn.Module):
    def __init__(self, hidden_size=128, device='cuda:2'):
        ...
        self.filter_sizes = [1, 2, 4, 8, 16, 32, 64, 128]  # tmux:1
        self.filter_sizes = [1, 2, 4, 8, 16, 24, 32, 64]  # tmux:0
        self.num_filters = 64
    ...
    for epoch in range(epoch_num):
        ...
        if test_acc > best_test_acc:
            ...
            filename = '{},{}, {}[{:.4f}].pt'.format('cls_Atten_model_{}_SEED={}_data{}'.format(half_length * 2 + 1 ,SEED,dataset) + ', epoch[{}]'.format(epoch + 1),model_name, 'ACC',
                                                  test_performance[0])
            save_path_pt = os.path.join(f'/mnt/sdb/home/lrl/code/Saved_models/Models/cls-Attn/', filename)
            ...
            save_path_roc = os.path.join(f'/mnt/sdb/home/lrl/code/Saved_models/ROC/cls-Attn/', filename)
            save_path_prc = os.path.join(f'/mnt/sdb/home/lrl/code/Saved_models/PRC/cls-Attn/', filename)
