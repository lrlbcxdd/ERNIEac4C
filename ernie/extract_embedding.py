...
def extract_embedding_of_ernierna(sequences, if_cls=True, arg_overrides = { "data": '/data/code/BERT/onestage_checkpoint_dict/' }, pretrained_model_path =  '/data/code/BERT/Pretrain_checkpoint/twocheckpoint_best.txt', device='cpu'):
    '''
    input:
    sequences: List of string (difference length)
