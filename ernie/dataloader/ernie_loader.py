...
def ernie_load_ac4c_data(batchsize,halfLength):
    ...
    train_file = r"/mnt/sdb/home/lrl/code/new_ac4c/ernie/data/new_test_data/new_modify_data3/train.csv"
    val_file = r"/mnt/sdb/home/lrl/code/new_ac4c/ernie/data/new_test_data/new_modify_data3/val.csv"
    test_file = r"/mnt/sdb/home/lrl/code/new_ac4c/ernie/data/new_test_data/new_modify_data3/test.csv"
    ...
    train_dataset = ErniedataSet.MyDataset(train_seq,train_label)
    val_dataset = ErniedataSet.MyDataset(val_seq, val_label)
    test_dataset = ErniedataSet.MyDataset(test_seq, test_label)
