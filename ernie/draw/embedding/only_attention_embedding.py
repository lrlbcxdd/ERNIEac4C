...
class Ernierna(nn.Module):
    ...
    def forward(self, one_d, two_d):  # torch.Size([16, 1, length + 2])
        ...
        output = self.fc[:1](rna_attn_map_embedding)
...
if __name__ == '__main__':
    ...
    model_path = "/mnt/sdb/home/lrl/code/Saved_models/Models/Only_Attn/Only_Attention_model_415_SEED=29_data4, epoch[12],RNA, ACC[0.9054].pt"
    ...
    torch.save(all_embedding, '../pt/only_att_embeddings.pt')
    torch.save(all_labels, '../pt/only_att_labels.pt')
