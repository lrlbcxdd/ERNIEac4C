...
if __name__ == '__main__':
    ...
    params_nni.update(tuner_params)
    ...
    optimizer = torch.optim.AdamW(model.parameters(),lr=params_nni['lr'])
    ...
    for epoch in range(epoch_num):
        ...
        nni.report_intermediate_result(test_performance[0])
        ...
        if test_acc > best_test_acc:
            ...
            filename = '{},{}, {}[{:.4f}].pt'.format('New1_Test_Atten_model_{}_SEED={}_data{}'.format(half_length * 2 + 1 ,SEED,dataset) + ', epoch[{}]'.format(epoch + 1),model_name, 'ACC',
                                                  test_performance[0])
