...
class Ernierna(nn.Module):
    def __init__(self, hidden_size=128, device='cuda:2'):
        ...
        self.block = nn.Sequential(
            nn.Linear(2650, 1024),  #415: 20850 201: 10250 101:79104 51: 2650
            nn.BatchNorm1d(1024),
            nn.Dropout(0.2),
            nn.LeakyReLU(),
            nn.Linear(1024, 256),
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_num):
        ...
        if test_acc > best_test_acc:
            ...
            filename = '{},{}, {}[{:.4f}].pt'.format('ERNIE+GRU_model_{}_SEED={}'.format(half_length*2+1,SEED) + ', epoch[{}]'.format(epoch + 1),model_name, 'ACC',
                                                  test_performance[0])
            save_path_pt = os.path.join(f'/mnt/sdb/home/lrl/code/Saved_models/ROC/ERNIE+GRU/', filename)
            ...
            save_path_roc = os.path.join(f'/mnt/sdb/home/lrl/code/Saved_models/ROC/ERNIE+GRU/', filename)
            save_path_prc = os.path.join(f'/mnt/sdb/home/lrl/code/Saved_models/ROC/ERNIE+GRU/', filename)
